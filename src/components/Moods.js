...
export default function Moods() {
  ...
  const [mood, setMood] = useState("Not sure how I feeeeel");

  const makeHappy = () => {
    setMood("I am Quite Happy");
  };
  const makeSad = () => {
    setMood("I am Quite SAD!");
  };
  const reset = () => {
    setMood("Not sure how I feeeeel");
  };
  ...
  const style = {
    ...
    marginBottom: "0.3em",
    color: `${
      mood === "I am Quite Happy" ? "royalblue" : "crimson"
    }` /* STEP 2 */,
  };
